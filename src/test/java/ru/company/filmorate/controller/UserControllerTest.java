...
//import ru.company.filmorate.controller.user.UserController;
...
//        User user =  new User(1L,"name", "login", "valid.email@example.com", LocalDate.of(2000, 12, 12), new HashSet<>());
//
//        mockMvcPerformPost(user)
//                .andExpect(status().isOk());
//
//        User updatedUser =  new User(1L,"name", "login", "valid.email@example.com",  LocalDate.of(3000, 12, 12), new HashSet<>());
//        mockMvcPerformPut(updatedUser, updatedUser.getId())
//                .andExpect(status().isBadRequest())
//                .andExpect(jsonPath("$.errors[0].field").value("birthday"))
//                .andExpect(jsonPath("$.errors[0].defaultMessage").value("Дата рождения не может быть в будущем"));
...
//        User user1 = new User(1L,"name", "login1", "valid1.email@example.com", 2000, 1, 1);
//        mockMvcPerformPost(user1)
//                .andExpect(status().isOk());
//
//        User user2 =  new User(1L,"name", "login2", "valid2.email@example.com", 2000, 1, 1);
//        mockMvcPerformPost(user2)
//                .andExpect(status().isOk());
//
//        User user3 = new User(1L,"name", "login3", "valid3.email@example.com", 2000, 1, 1);
...
//        User user = new User(1L,"name", "login1", "valid1.email@example.com", 2000, 1, 1);
//
//        mockMvcPerformPost(user)
//                .andExpect(status().isOk());
//
...
//        User user = new User(1L, "name", "login1", "duplicate.email@example.com", 2000, 1, 1);
//
//        mockMvcPerformPost(user)
//                .andExpect(status().isOk());
//
//        User duplicateUser = new User(1L, "name", "login1", "duplicate.email@example.com", 2000, 1, 1);
//
...
//    }
//
//    private ResultActions mockMvcPerformPut(User updatedUser, long userId) throws Exception {
